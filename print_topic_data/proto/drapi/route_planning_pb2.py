...
_MRMLANECHANGESTATUS = DESCRIPTOR.enum_types_by_name['MRMLaneChangeStatus']
MRMLaneChangeStatus = enum_type_wrapper.EnumTypeWrapper(_MRMLANECHANGESTATUS)
...
MRM_TASK_TIMEOUT = 501
MRM_USER_CANCEL = 502
MRM_SLOW_SPEED_LANE = 503
MRM_LANE_CHANGE_TIMEOUT = 504
MRM_TOLL_OR_RAMP_CANNOT_STOP = 505
MRM_TUNNEL_OR_FORK_CANNOT_STOP = 506
MRM_CURRENT_LANE_CLOSE = 507
MRM_RIGHT_LANE_CLOSE = 508
MRM_RIGHT_LANE_OBSTACLE = 509
MRM_EMERGENCY_LANE_OBSTACLE = 510
MRM_RIGHT_CONSTRUCTION_ZONE = 511
NO_LANE_CHANGE = 0
DURING = 1
SUCCESS = 2
FAIL = 3
...
VLA_FAILED = 3
VLA_END = 4
MRM_LANE_CHANGE_UNKNOWN = 0
MRM_LANE_CHANGE_WAITING = 1
MRM_LANE_CHANGE_DURING = 2
MRM_LANE_CHANGE_HOLD = 3
MRM_SINGLE_LANE = 4
MRM_FAILED = 5
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _BEHAVIORREASON._serialized_end=4034
  _LANECHANGESTATUS._serialized_start=4037
  _LANECHANGESTATUS._serialized_end=4246
  _VLASTATUS._serialized_start=4248
  _VLASTATUS._serialized_end=4340
  _MRMLANECHANGESTATUS._serialized_start=4343
  _MRMLANECHANGESTATUS._serialized_end=4513
  _STOPREASON._serialized_start=4516
  _STOPREASON._serialized_end=4718
