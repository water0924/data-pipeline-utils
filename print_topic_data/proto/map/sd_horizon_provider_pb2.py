...
_GUIDANCELANEINFO = DESCRIPTOR.message_types_by_name['GuidanceLaneInfo']
_GUIDANCEINTEGRATIONINFO = DESCRIPTOR.message_types_by_name['GuidanceIntegrationInfo']
...
_SDROADSCENE = DESCRIPTOR.message_types_by_name['SdRoadScene']
_FUSIONSDMAP = DESCRIPTOR.message_types_by_name['FusionSdMap']
_GUIDANCELANEINFO_LANEARROW = _GUIDANCELANEINFO.enum_types_by_name['LaneArrow']
_GUIDANCELANEINFO_LANETYPE = _GUIDANCELANEINFO.enum_types_by_name['LaneType']
_GUIDANCEINTEGRATIONINFO_MUTABLESIGNGROUPTYPE = _GUIDANCEINTEGRATIONINFO.enum_types_by_name['MutableSignGroupType']
_FUSIONSDMAP_FUSIONMAPTYPE = _FUSIONSDMAP.enum_types_by_name['FusionMapType']
...
GuidanceLaneInfo = _reflection.GeneratedProtocolMessageType('GuidanceLaneInfo', (_message.Message,), {
  'DESCRIPTOR' : _GUIDANCELANEINFO,
  '__module__' : 'map.sd_horizon_provider_pb2'
  # @@protoc_insertion_point(class_scope:deeproute.map.GuidanceLaneInfo)
  })
_sym_db.RegisterMessage(GuidanceLaneInfo)

GuidanceIntegrationInfo = _reflection.GeneratedProtocolMessageType('GuidanceIntegrationInfo', (_message.Message,), {
  'DESCRIPTOR' : _GUIDANCEINTEGRATIONINFO,
  '__module__' : 'map.sd_horizon_provider_pb2'
  # @@protoc_insertion_point(class_scope:deeproute.map.GuidanceIntegrationInfo)
  })
_sym_db.RegisterMessage(GuidanceIntegrationInfo)
...
SdRoadScene = _reflection.GeneratedProtocolMessageType('SdRoadScene', (_message.Message,), {
  'DESCRIPTOR' : _SDROADSCENE,
  '__module__' : 'map.sd_horizon_provider_pb2'
  # @@protoc_insertion_point(class_scope:deeproute.map.SdRoadScene)
  })
_sym_db.RegisterMessage(SdRoadScene)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _GUIDANCELANEINFO._serialized_start=1043
  _GUIDANCELANEINFO._serialized_end=1480
  _GUIDANCELANEINFO_LANEARROW._serialized_start=1188
  _GUIDANCELANEINFO_LANEARROW._serialized_end=1418
  _GUIDANCELANEINFO_LANETYPE._serialized_start=1420
  _GUIDANCELANEINFO_LANETYPE._serialized_end=1480
  _GUIDANCEINTEGRATIONINFO._serialized_start=1483
  _GUIDANCEINTEGRATIONINFO._serialized_end=1996
  _GUIDANCEINTEGRATIONINFO_MUTABLESIGNGROUPTYPE._serialized_start=1867
  _GUIDANCEINTEGRATIONINFO_MUTABLESIGNGROUPTYPE._serialized_end=1996
  _TRAFFICLIGHT._serialized_start=1998
  _TRAFFICLIGHT._serialized_end=2077
  _REALTIMEGUIDANCE._serialized_start=2080
  _REALTIMEGUIDANCE._serialized_end=2817
  _SDROADSCENE._serialized_start=2819
  _SDROADSCENE._serialized_end=2904
  _FUSIONSDMAP._serialized_start=2907
  _FUSIONSDMAP._serialized_end=3305
  _FUSIONSDMAP_FUSIONMAPTYPE._serialized_start=3118
  _FUSIONSDMAP_FUSIONMAPTYPE._serialized_end=3305
