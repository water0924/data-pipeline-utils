...
_CANCELTRIGGERREQUEST = DESCRIPTOR.message_types_by_name['CancelTriggerRequest']
_PREVIEWTRIGGERS = DESCRIPTOR.message_types_by_name['PreviewTriggers']
...
CancelTriggerRequest = _reflection.GeneratedProtocolMessageType('CancelTriggerRequest', (_message.Message,), {
  'DESCRIPTOR' : _CANCELTRIGGERREQUEST,
  '__module__' : 'recorder.trigger_pb2'
  # @@protoc_insertion_point(class_scope:deeproute.recorder.CancelTriggerRequest)
  })
_sym_db.RegisterMessage(CancelTriggerRequest)

PreviewTriggers = _reflection.GeneratedProtocolMessageType('PreviewTriggers', (_message.Message,), {
  'DESCRIPTOR' : _PREVIEWTRIGGERS,
  '__module__' : 'recorder.trigger_pb2'
  # @@protoc_insertion_point(class_scope:deeproute.recorder.PreviewTriggers)
  })
_sym_db.RegisterMessage(PreviewTriggers)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _GRADINGTRIGGERREQUEST._serialized_end=529
  _CANCELTRIGGERREQUEST._serialized_start=531
  _CANCELTRIGGERREQUEST._serialized_end=568
  _PREVIEWTRIGGERS._serialized_start=570
  _PREVIEWTRIGGERS._serialized_end=610
