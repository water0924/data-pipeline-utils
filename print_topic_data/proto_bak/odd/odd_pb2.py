...
_ODDACTION = DESCRIPTOR.enum_types_by_name['OddAction']
OddAction = enum_type_wrapper.EnumTypeWrapper(_ODDACTION)
ODD_UNKNOWN = 0
ODD_REST_AREA = 1
ODD_TOLL = 2
...
_ODDTYPEINFO = DESCRIPTOR.message_types_by_name['OddTypeInfo']
...
OddTypeInfo = _reflection.GeneratedProtocolMessageType('OddTypeInfo', (_message.Message,), {
  'DESCRIPTOR' : _ODDTYPEINFO,
  '__module__' : 'odd.odd_pb2'
  # @@protoc_insertion_point(class_scope:deeproute.odd.OddTypeInfo)
  })
_sym_db.RegisterMessage(OddTypeInfo)
